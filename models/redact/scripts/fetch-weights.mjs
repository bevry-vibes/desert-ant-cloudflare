...
const HF_BASE = "https://huggingface.co/desert-ant-labs/redact/resolve/main";

/** Weight files fetched from the Hugging Face Hub. */
const downloads = [
	{ name: "redact.tflite", minBytes: 5_000_000 },
	{ name: "labels.json", minBytes: 100 },
	{ name: "redact_tokenizer.bin", minBytes: 100_000 },
];
